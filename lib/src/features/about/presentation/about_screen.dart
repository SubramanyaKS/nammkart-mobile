      ...
      Padding(
        ...
        child: Column(
          children: [
            ...
            // SizedBox(height: 30,),
            Text(AboutData.appNAme, style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold, color: Colors.deepPurple),),
            ...
            Container(
              ...
              child: Icon(Icons.shopping_cart,size: 60,color: Colors.deepPurple,)),
            SizedBox(height: 20,),
